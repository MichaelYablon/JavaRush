...
public class Solution {
    ...
    public static void printMatrix(String m, Object o){}
    public static void printMatrix(String m, Integer in){}
    public static void printMatrix(String m, Integer in, float f){}
}
